...
{
    unsafe class xbuffer_boolBuffer_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(xbuffer.boolBuffer);
            ...
            args = new Type[]{typeof(System.Boolean), typeof(xbuffer.XSteam)};
        ...
        static StackObject* deserialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = xbuffer.boolBuffer.deserialize(@buffer, ref @offset);
        ...
        static StackObject* serialize_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            xbuffer.boolBuffer.serialize(@value, @steam);
