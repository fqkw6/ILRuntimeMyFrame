...
{
    unsafe class xbuffer_longBuffer_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(xbuffer.longBuffer);
            ...
            args = new Type[]{typeof(System.Int64), typeof(xbuffer.XSteam)};
        ...
        static StackObject* deserialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = xbuffer.longBuffer.deserialize(@buffer, ref @offset);
        ...
        static StackObject* serialize_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            xbuffer.longBuffer.serialize(@value, @steam);
