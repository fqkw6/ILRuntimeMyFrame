...
{
    unsafe class xbuffer_stringBuffer_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(xbuffer.stringBuffer);
            args = new Type[]{typeof(System.Byte[]), typeof(System.UInt32).MakeByRefType()};
            method = type.GetMethod("deserialize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, deserialize_0);
            args = new Type[]{typeof(System.String), typeof(xbuffer.XSteam)};
        ...
        static StackObject* deserialize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = xbuffer.stringBuffer.deserialize(@buffer, ref @offset);
        ...
        static StackObject* serialize_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            xbuffer.XSteam @steam = (xbuffer.XSteam)typeof(xbuffer.XSteam).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            xbuffer.stringBuffer.serialize(@value, @steam);
