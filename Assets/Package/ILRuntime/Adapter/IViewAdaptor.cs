...
public class IViewAdaptor : CrossBindingAdaptor
{
    ...
    public class Adaptor : IView, CrossBindingAdaptorType
    {
        ...
        {
            IMethod method = null;
            method = instance.Type.GetMethod("OnDestory", 0);
            if (method == null)
            {
                Debug.LogError("OnDestory Error");
                return;
            }
            else
            {
